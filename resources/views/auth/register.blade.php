...
<head>
  ...
  <title>Pages / Register - Silelang Bootstrap Template</title>
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Silelang</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form action="{{ route('register') }}" method="POST" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-sm-10">
                      <label for="" class="form_label mb-3">Kamu registrasi sebagai apa?</label>
