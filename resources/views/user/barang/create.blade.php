    ...
    <div class="card-body">
      ...
      <form action="{{ route('barang.store') }}" method="POST" class="row g-3" enctype="multipart/form-data">
        ...
        <div class="col-12">
          ...
          <input type="date" name="waktu" class="form-control" id="inputNanme4">
        </div> 
        
        <div class="col-12">
          <label for="inputNanme4" class="form-label">Harga awal</label>
          <input type="number" name="harga_awal" class="form-control" id="inputNanme4">
        </div> 
        <div class="col-12">
          <label for="inputNanme4" class="form-label">Deskripsi awal</label>
          <input type="text" name="deskripsi_awal" class="form-control" id="inputNanme4">
        </div> 
        <div class="col-12">
